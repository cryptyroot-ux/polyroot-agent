...
- Ledger keuangan di **PostgreSQL**; AI hanya bisa *mengusulkan intent*, tidak bisa sign/submit
...
*Dokumen ini adalah hasil studi dan diskusi. Belum ada implementasi kode.*
